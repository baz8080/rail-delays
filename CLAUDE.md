...
| "Newest first, by when Irish Rail first listed the notice" is "Newest first" - every row underneath already carries the date. The capacity count went from twenty-six words to six: "142 trains had reduced capacity, but they are not counted as a delay" | `notes/site.md` § "Newest first" and the capacity count shortened |
